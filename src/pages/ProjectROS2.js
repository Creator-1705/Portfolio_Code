...
const ProjectROS2 = () => {
  ...
  return (
    <div className="project-page">
      ...
      <img src={zedcamera} alt="ZED camera" style={imgStyle} />
      ...
      <img src={jetsonnano} alt="Jetson Nano" style={imgStyle} />
      <p style={{ fontSize: '1rem', color: '#ccc', marginBottom: '2rem' }}>
      ...
      <img src={jetnano2} alt="Jetson work" style={imgStyle} />

      <p style={{ fontSize: '1rem', color: '#ccc', marginBottom: '2rem' }}>
        This is the pointcloud visualization from the depth data from ZED camera.
      </p>

      <img src={rtabmap2} alt="RTAB Map 2" style={imgStyle} />
      <p style={{ fontSize: '1rem', color: '#ccc', marginBottom: '2rem' }}>
        RTAB Map package used for 3D mapping
      </p>

      <img src={rtabmap3} alt="RTAB Map 3" style={imgStyle} />
      <p style={{ fontSize: '1rem', color: '#ccc', marginBottom: '2rem' }}>
        Loop Closure detection in RTAB Map
      </p>

      <img src={rtabmap4} alt="RTAB Map 4" style={imgStyle} />
      <p style={{ fontSize: '1rem', color: '#ccc', marginBottom: '2rem' }}>
        Partial 3D map generated from the robot and RTAB map
      </p>

      <img src={rtabmapnew5} alt="RTAB Map 5" style={imgStyle} />
      <p style={{ fontSize: '1rem', color: '#ccc', marginBottom: '2rem' }}>
        RTAB Map Viewer
      </p>
